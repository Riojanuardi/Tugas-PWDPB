                ...
                <div class="card-stats">
                  <div class="card-stats-title">DATA KELAS -
                    <div class="dropdown d-inline">
                      <a class="font-weight-600 dropdown-toggle" data-toggle="dropdown" href="#" id="orders-month">Kelas</a>
                      <ul class="dropdown-menu dropdown-menu-sm">
                        <li class="dropdown-title">Pilih Kelas</li>
                        <li><a href="kelas.php" class="dropdown-item active">X RPL</a></li>
                        <li><a href="kelas.php" class="dropdown-item active">XI RPL</a></li>
                        <li><a href="kelas.php" class="dropdown-item active">XII RPL</a></li>
                      </ul>
                    </div>
                  </div>
